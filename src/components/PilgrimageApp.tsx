...
const recommendedCourses: RecommendedCourse[] = [
  {
    ...
    region: "서울",
    duration: "반나절-1일",
    shrineIds: ["명동대성당-순교성지", "서소문-밖-네거리-순교성지-순교성지", "중림동-약현성당-순례지"]
  },
  {
    id: "ganghwa_course",
    title: "강화 순교 코스",
  ...
  },
  {
    ...
    shrineIds: [
      ...
      "광암이벽요한세례자-진묘터와-생가터",
      "소양로-순례-성당-순교자-고-안토니오-anthony-collier",
      "죽림동-순교-성지-625-순교자-묘역"
    ]
  },
  {
    id: "incheon_course",
    ...
    region: "인천",
    duration: "반나절",
    shrineIds: ["이승훈-베드로-묘반주골", "제물진두-순교-성지"]
  },
  {
    id: "south_gg1_course",
    title: "경기 기억과 믿음의 길",
    ...
    region: "경기남부",
    duration: "1일",
    shrineIds: ["수리산성지", "손골성지", "수원화성순교성지", "남양성모성지", "요당리성지"]
  },
  {
    id: "south_gg2_course",
    title: "경기 은총의 길",
    ...
    region: "경기남부",
    duration: "1일",
    shrineIds: ["구산성지", "마재-성가정-성지", "양근성지", "천진암성지", "남한산성-순교성지"]
  },
  {
    id: "south_gg3_course",
    title: "경기 빛을 따라 걷는 길",
    ...
    region: "경기남부",
    duration: "1일",
    shrineIds: ["은이골배마실성지", "단내성가정성지", "어농성지", "죽산성지", "미리내성지"]
  },
  {
    id: "west_gw_course",
    title: "강원, 충북 순례코스",
    ...
    region: "강원서부,충북",
    duration: "1일",
    shrineIds: ["풍수원-성당", "강원-감영", "성-남종삼-요한--순교자-남상교-아우구스티노-유택지", "배론-성지"]
  },
  {
    id: "east_gw_course",
    title: "강원 순례코스",
    ...
    shrineIds: [
      "양양-성지-순교자-이광재-디모테오",
      "순교자-라-파트리치오patrick-reilly-신부-순교터",
